...
boxId = p.loadURDF("/home/amit/Documents/test/ur5-robotiq-140/urdf/objects/block.urdf", deskStartPos, deskStartOrientation)

tableStartPos = [0.0, -0.9, 0.8]
tableStartOrientation = p.getQuaternionFromEuler([0, 0, 0])
boxId1 = p.loadURDF("/home/amit/Documents/test/ur5-robotiq-140/urdf/objects/table.urdf", tableStartPos, tableStartOrientation,useFixedBase = True)

ur5standStartPos = [-0.7, -0.36, 0.0]
ur5standStartOrientation = p.getQuaternionFromEuler([0, 0, 0])
boxId1 = p.loadURDF("/home/amit/Documents/test/ur5-robotiq-140/urdf/objects/ur5_stand.urdf", ur5standStartPos, ur5standStartOrientation,useFixedBase = True)
